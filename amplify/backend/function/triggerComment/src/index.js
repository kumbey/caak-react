...
const {createCommentTotals, updateCommentTotals, removeCommentTotals} = require("./resolver/CommentTotals")

const Resolver = {
    INSERT: createCommentTotals,
    MODIFY: updateCommentTotals,
    REMOVE: removeCommentTotals
}
