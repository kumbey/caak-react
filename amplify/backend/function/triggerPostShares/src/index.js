...
const {createPostSharesTotals, updatePostSharesTotals, removePostSharesTotals} = require("./resolver/PostSharesTotals")

const Resolver = {
    INSERT: createPostSharesTotals,
    MODIFY: updatePostSharesTotals,
    REMOVE: removePostSharesTotals
}
