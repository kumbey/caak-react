  ...
  return (
    <div className={"relative"}>
      ...
      {data.length > 1 ? (
        <div
          className={
            `flex flex-row tracking-wide items-center text-center align-middle absolute font-bold top-3 left-20 text-white text-11px bg-black bg-opacity-20 rounded px-2 py-1`
          }
        >
