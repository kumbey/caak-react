...
export default function ProfileHoverCard({ setHover }) {
  return (
    <div
    ...
    >
      <div className="mt-c6 flex flex-row items-center justify-between w-full">
        ...
        />
        <Button className="text-15px w-c19 font-bold">Дагах</Button>
      </div>
      <div className="mb-b1">
        <div className=" flex items-center">
          <p className="text-17px font-bold">Tulgaa</p>
          <span className="icon-fi-rs-verified text-13px text-caak-buttonblue " />
        </div>
        <p className="text-15px font-light">energy never lies 🍓</p>
      </div>
      <div className=" pr-14 flex flex-row items-center justify-between">
        <div className="flex items-center" style={{ marginRight: "22px" }}>
          <p className="text-18px mr-1 font-medium">2434</p>
          <p className="text-15px text-caak-darkBlue font-light"> Аура</p>
        </div>
        <div className="flex items-center">
          <p className="text-18px mr-1 font-medium">853</p>
