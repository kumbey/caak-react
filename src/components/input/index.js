...
const Input = ({labelStyle, hideLabel, label, className, errorMessage, error, ...props}) => {
    return (
        <div>
            ...
            <input
                ...
                hover:bg-white transition ease-in duration-100 " ${className} ${error && "border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500"}`}
            />
