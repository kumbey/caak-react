...
export default function GroupHeader({ title,profile,cover}) {
    ...
    return (
        <div>
            <img alt="cover" src={generateFileUrl(cover)}  className="w-full  h-c17 bg-caak-blue"/>
            ...
            <div className="absolute  bottom-b3 2xl:left-cf 2xl:right-cf xl:left-c18 xl:right-c18  lg:left-c12 lg:right-c12 sm:left-b1 sm:right-b1 ">
                <div className="flex justify-between">
                    ...
                    <img alt="" src={generateFileUrl(profile)} className="w-c19 h-c19 border-4 border-white bg-caak-red rounded-lg"/>
                        <div className="ml-c6">
                        <div>
                    <p className="text-26px font-bold text-caak-generalblack">{title}</p>
                </div>
