...
const ViewPost = () => {
  ...
  return post ? (
    <Backdrop>
      <div
        className={
          "fullscreen_header_size flex flex-col justify-between sm:flex-col md:flex-col lg:flex-row m-10"
        }
      >
        <div
          className={
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className={"relative flex w-3/5 justify-center items-center"}
              >
                <textarea
                  rows={1}
                  className={
